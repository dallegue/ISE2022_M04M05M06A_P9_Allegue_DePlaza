...
t <td width="5%"></td>
c b 3 <td><input type=checkbox name=led3 OnClick="submit();" %s>4</td>
c b 2 <td><input type=checkbox name=led2 OnClick="submit();" %s>3</td>
c b 1 <td><input type=checkbox name=led1 OnClick="submit();" %s>2</td>
c b 0 <td><input type=checkbox name=led0 OnClick="submit();" %s>1</td>
t </font></table></td></tr>
